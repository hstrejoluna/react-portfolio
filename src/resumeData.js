export const resumeData = [
  {
    main: {
      ...
      resumedownload:
        "https://drive.google.com/file/d/1KxZ4i9ZkMSgGK5MkNGDiis0Okw595lh1/view?usp=sharing",
      social: [
        {
          name: "facebook",
          url: "https://www.facebook.com/hstrejoluna",
          className: "fa fa-facebook",
        },

        {
          name: "linkedin",
          url: "https://www.linkedin.com/in/hstrejoluna/",
          className: "fa fa-linkedin",
        },
        {
          name: "instagram",
          url: "https://www.instagram.com/hstrejoluna/",
          className: "fa fa-instagram",
        },
        {
          name: "github",
          url: "https://github.com/hstrejoluna/",
      ...
      education: [
        {
          ...
          degree: "Organizational Intelligence and Data Enginnering",
          graduated: "Non-Graduated",
        },
        {
          school: "CECyTE I Cancun",
          degree: "Technician Support and Maintenance of Computer Equipment",
        },
      ],
      work: [
        {
          company: "Kekhol Inmobiliaria",
          title: "WordPress Web Developer and IT Assistant ",
          years: "may 2020 – march 2021",
          description:
            "IT Assistant \n- Intranet Network Configuration, Windows Server, Email Server setting up.• Printers setup and support.• Ticket resolution (i.e. Problems with hardware, software ). WordPress Based Web Development:• Taking Requirements .• Hosting Administration (Billing, Support, Setting Up).• FTP Server Administrator.• MySQL Database Administrator, PhpMyAdmin.• FullStack Web Development  (php, javascript, html, css.) • ICustom Plugin Development, license administrator, Theme Customization. - Managment of analytics tools ( Google Analytics, Facebook Pixel, and more)",
        },
        {
          company: "Grupo DEPI del Caribe",
          title: "WordPress Web Developer and IT Assistant ",
    ...
    portfolio: {
      projects: [
        ...
        },
        {
          ...
          category: "Install and Config plugins, technical SEO, maintenance",
          image: "p15.png",
        ...
        {
          title: "Nexter",
          category: "Discovering the power of css grid",
          image: "p11.png",
